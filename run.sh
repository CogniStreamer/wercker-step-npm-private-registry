...
if [ -n "$WERCKER_NPM_PRIVATE_REGISTRY_USERNAME" ] && [ -n "$WERCKER_NPM_PRIVATE_REGISTRY_PASSWORD" ] && [ -n "$WERCKER_NPM_PRIVATE_REGISTRY_EMAIL" ]; then
npm adduser --registry $REGISTRY <<EOF
$WERCKER_NPM_PRIVATE_REGISTRY_USERNAME
$WERCKER_NPM_PRIVATE_REGISTRY_PASSWORD
